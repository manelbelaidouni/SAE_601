...
| Impossible d'importer le .txt en ouvrant index.html directement | Restriction du navigateur en mode file:// | Utilisation d’un serveur local pour faire fonctionner l’import |
...
1. Accédez au dossier : `cd phase2/phase2-Claude`
