...
let bx = 10, by = 20; 
//Act
let distance_1 = calculer_distance_entre_deux_points(ax, ay, bx, by); 
//Assert
if (distance_1 === 10) {
...
let cx = 5, cy = 5; 
//Act
let distance_2 = calculer_distance_entre_deux_points(cx, cy, cx, cy); 
//Assert
if (distance_2 === 0) {
...
//Arrange
let couleur_1 = genererCouleurAleatoire(); 
let couleur_2 = genererCouleurAleatoire(); 
//Act + Assert
...
//Arrange
listeDesPoints = []; // le liste qui est vide
//Act
let res = couleurDejaUtilisee("rgb(100,100,100)"); // couleur qui n'est pas dans liste
//Assert
if (res === false) {
